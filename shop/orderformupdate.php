...
$push_message = "상품의 주문이 완료되었습니다.";
$target_url = G5_URL."/mypage/myorder_view.php?od_id=".$od_id;
$push->sendGoodsQaReplyNotification($member['mb_id'], $push_message, $target_url);
