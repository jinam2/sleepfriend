...
if(!$prescription['INSPECTION_PDF']) {
    alert_close("검사결과지 파일 조회 불가");
}

$pdf_file = G5_DATA_PATH."/downloads/INSPECTION_".$prescription['ID'].".png";

$decoded = base64_decode($prescription['PRESCRIPTION_PDF']);

$file = "INSPECTION_".$prescription['ID'].".png";
