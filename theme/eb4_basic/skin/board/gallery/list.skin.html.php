...
.board-gallery .gallery-item, .board-gallery .gallery-sizer {position:relative; display:block; margin:0 0 40px; width:50%;}
.board-gallery .gallery-item-pd {padding:0 10px}
.board-gallery .gallery-item-in {position:relative;background:#fff;}
...
.board-gallery .gallery-item .gallery-item-image-in {position:relative;overflow:hidden;max-height:540px;}
.board-gallery .gallery-item .gallery-item-image-in img {width:100%;}
.board-gallery .gallery-item .gallery-item-image-in:after {content:"";text-align:center;position:absolute;display:block;left:0;top:0;opacity:0;-moz-transition:all 0.2s ease 0s;-webkit-transition:all 0.2s ease 0s;-ms-transition:all 0.2s ease 0s;-o-transition:all 0.2s ease 0s;transition:all 0.2s ease 0s;width:100%;height:100%;background:rgba(0,0,0,0.4)}
.board-gallery .gallery-item .gallery-item-image-in .movie-icon {display:inline-block;position:absolute;top:50%;left:50%;width:60px;height:60px;line-height:60px; border-radius:50%; text-align:center;color:#fff; background:#FD4F00; font-size:16px; padding-left:5px;transform:translate(-50%,-50%);z-index:1}
...
.board-gallery .gallery-item .gallery-item-info {position:relative;padding:15px 0 0;}
.board-gallery .gallery-item .gallery-item-info h4 {font-size:24px;color:#343434; min-height:70px;line-height:1.4;word-break:keep-all;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;margin-bottom:15px}
.board-gallery .gallery-item .gallery-item-info h4 a:hover {color:#fd4f00;}
.board-gallery .gallery-item .gallery-item-info h4 .gallery-new-icon {position:relative;display:inline-block;width:16px;height:16px; line-height:16px; vertical-align:middle; border-radius:3px; text-align:center; font-size:11px; background-color:#cc2300; margin:0 0 4px 5px; padding:0; color:#fff;}
...
.board-gallery .gallery-item .gallery-item-info .gallery-cont {position:relative; color:#5f5f5f;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;
-webkit-box-orient:vertical; margin-bottom:20px; font-size:16px; line-height:160%; min-height:54px;}
...
.board-gallery .gallery-item .gallery-item-bottom {position:relative;}
...
@media (max-width:991px) {
	...
	.board-gallery .gallery-item .gallery-item-info h4 {font-size:22px;}
}
@media (max-width:767px) {
	.board-list {font-size:15px;}
    .board-gallery .gallery-item-in .gallery-item-category {padding:10px 0}
    .board-gallery .gallery-item .gallery-item-image-in .movie-icon {width:40px;height:40px;line-height:40px;font-size:30px}
    .board-gallery .gallery-item .gallery-item-info {padding:10px 0 0;}
	...
	.board-gallery .gallery-item, .board-gallery .gallery-sizer {width:100%; margin-bottom:30px;}
	.board-gallery .gallery-item .gallery-item-info h4 {font-size:20px; margin:10px 0 20px; min-height:auto;}
	.board-gallery .gallery-item .gallery-item-info .gallery-cont {font-size:15px;}
}
...
<div class="board-list">
    ...
    <div class="board-info m-b-20">
        ...
        <?php if ($write_href) { ?>
        <div class="float-end">
            <a href="<?php echo $write_href; ?>" class="btn-e btn-e-sm btn-dark" type="button">글쓰기</a>
        </div>
        <?php } ?>
                    ...
                    <div class="gallery-item-image">
                        <a href="<?php echo $list[$i]['href']; ?>" <?php echo $infinite_wmode ? 'onclick="eb_modal(this.href); return false;"': ''; ?>>
                            <div class="gallery-item-image-in">
                                ...
                                <span class="movie-icon"><i class="fa fa-play" aria-hidden="true"></i></span>
                                <?php } ?>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="gallery-item-info">
                        <h4>
                            <a href="<?php echo $list[$i]['href']; ?>" <?php echo $infinite_wmode ? 'onclick="eb_modal(this.href); return false;"': ''; ?>>
                                ...
                                <span class="gallery-new-icon">N</span>
                                <?php } ?>
                            </a>
                            <?php if ($is_checkbox) { ?>
                        ...
                        <!--p class="gallery-cont">
                            <?php if (!G5_IS_MOBILE) { ?>
							<?=cut_str(str_replace("&nbsp;", "", trim(strip_tags($list[$i]['wr_content']))), 180)?>
                            <?php } else { ?>
							<?=cut_str(str_replace("&nbsp;", "", trim(strip_tags($list[$i]['wr_content']))), 80)?>
                            <?php } ?>
                        </p-->
                        <?php } ?>
                    </div>
