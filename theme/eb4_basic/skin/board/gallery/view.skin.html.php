...
.board-view .board-view-file-conts #bo_v_img img {display:block;max-width:100%;height:auto; margin:30px 0;}
...
<article class="board-view">
    ...
    <div class="view-top-btn">
        ...
        <ul class="top-btn-left list-unstyled float-start">
            <?php if ($prev_href) { ?>
            <li><a href="<?php echo $prev_href; ?>" class="btn-e-lg btn-e-dark" type="button">이전글</a></li>
            <?php } ?>
            <?php if ($next_href) { ?>
            <li><a href="<?php echo $next_href; ?>" class="btn-e-lg btn-e-dark" type="button">다음글</a></li>
            <?php } ?>
        </ul>
        <?php } ?>
        <?php } ?>
        <ul class="top-btn-right list-unstyled float-end">
            ...
            <li><a href="<?php echo $reply_href; ?>" class="btn-e-lg btn-e-dark" type="button">답변</a></li>
                <?php } ?>
                <?php if ($write_href) { ?>
            <li><a href="<?php echo $write_href; ?>" class="btn-e-lg btn-e-red" type="button">글쓰기</a></li>
                <?php } ?>
            <?php } ?>
        </ul>
        <div class="clearfix"></div>
