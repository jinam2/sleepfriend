...
.board-webzine .webzine-item {position:relative; border-top:1px solid #c4c4c4;width:100%;padding:40px 0;display:flex; }
.board-webzine .webzine-item:first-child {border-top:0; padding-top:0;}
.board-webzine .webzine-item .webzine-img {flex-shrink:0;width:300px;margin-right:40px;}
...
.board-webzine .webzine-item .webzine-img-box {position:relative;overflow:hidden;max-height:230px;border-radius:20px;}
...
.board-webzine .webzine-item .webzine-desc h4 {font-size:24px;color:#343434;margin-top:0;margin-bottom:20px;line-height:1.3;word-break:keep-all;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
.board-webzine .webzine-item .webzine-desc h4 .category {display:block; color:#FD4F00; font-size:14px; margin:12px 0 20px;}
.board-webzine .webzine-item .webzine-desc h4 .webzine-new-icon {position:relative;display:inline-block;width:16px;height:16px; line-height:16px; vertical-align:middle; border-radius:3px; text-align:center; font-size:11px; background-color:#cc2300; margin:0 0 4px 5px; padding:0; color:#fff;}
.board-webzine .webzine-item .webzine-desc h4 a:hover {color:#fd4f00;}
.board-webzine .webzine-item .webzine-checkbox {display:inline-block;position:absolute;top:-2px;right:-10px;z-index:1;}
.board-webzine .webzine-item .webzine-cont {position:relative; color:#5f5f5f;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:3;
-webkit-box-orient:vertical;margin-bottom:20px; font-size:16px; line-height:160%;}
.board-webzine .webzine-item .webzine-info {position:relative;}
...
@media (max-width:991px) {
    ...
    .board-webzine .webzine-item .webzine-img-box {max-height:200px;}
	.board-webzine .webzine-item .webzine-desc h4 .category {margin:4px 0 14px;}
	.board-webzine .webzine-item .webzine-desc h4 {font-size:22px;}
}
...
@media (max-width:767px) {
    ...
    .board-webzine .webzine-item .webzine-img-box {max-height:300px;}
    .board-webzine .webzine-item .webzine-img-box img {width:100%;}
	...
	.board-webzine .webzine-item .webzine-desc h4 .category {margin:10px 0 10px;}
	.board-webzine .webzine-item .webzine-desc h4 {font-size:20px; margin:0 0 15px;}
	.board-webzine .webzine-item .webzine-cont {font-size:15px;}
}

@media (max-width:480px) {
    .board-webzine .webzine-item {padding:30px 0;}
    .board-webzine .webzine-item .webzine-img-box {max-height:260px;}
}
</style>
            ...
            <div class="webzine-desc">
                <h4>
                    ...
                    <a href="<?php echo $list[$i]['href']; ?>" <?php echo $infinite_wmode ? 'onclick="eb_modal(this.href); return false;"': ''; ?>>
                        ...
                        <span class="text-crimson">열람중</span><?php echo $list[$i]['subject']; ?>
                        <?php ;} else { ?>
                        <?php echo $list[$i]['subject']; ?>
                        <?php ;} ?>
                        <?php if ($list[$i]['icon_new']) { ?>
                        <span class="webzine-new-icon">N</span>
                        <?php ;} ?>
                    </a>
                    <?php if ($is_checkbox) { ?>
                ...
                <p class="webzine-cont">
                    <?php if (!G5_IS_MOBILE) { ?>
                    <?php echo cut_str($list[$i]['wr_content'],320, '…'); ?>
                    <?php ;} else { ?>
                    <?php echo cut_str($list[$i]['wr_content'],80, '…'); ?>
                    <?php ;} ?>
                </p>
