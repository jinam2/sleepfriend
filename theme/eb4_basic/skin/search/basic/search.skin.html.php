...
<style>
.search-result {max-width:1400px; margin:0 auto; padding:0 0 100px;}
.search-result .search-box {position:relative;padding:25px 30px;margin-bottom:30px;border:1px solid #b5b5b5;background:#fff;border-radius:3px !important}
...
@media (max-width:1440px) {
	.search-result {padding:0 20px 100px;}
}

@media (max-width:980px) {
	.p-l-15 {padding-left:0 !important;}
}

@media (max-width:767px) {
	.search-result {padding:0 20px 70px;}
}
</style>
...
<div class="search-result">
    ...
    <div class="search-box">
        <div class="row">
            ...
            <div class="col-lg-3 inline-group m-b-15 p-l-15">
