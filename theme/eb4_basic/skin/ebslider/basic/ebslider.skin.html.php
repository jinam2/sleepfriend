...
.ebs-basic-in .ebs-basic .ebs-basic-item {position:relative;outline:none; text-align:center;}
.ebs-basic-in .ebs-basic .ebs-basic-item img {display:block;max-width:100%;height:auto; margin:0 auto;}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont {position:absolute;top:0;bottom:0;left:0;right:0;padding:50px 70px;word-break:keep-all}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont h2 {display:none; color:#fff;font-weight:700}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont h5 {display:none; color:#fff;margin-top:20px;font-size:1.375rem}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont p {margin-top:20px;font-size:1rem;color:#fff}
.ebs-basic-in .ebs-basic .slick-dots {bottom:50px;z-index:2}
.ebs-basic-in .ebs-basic .slick-dots li {position:relative; width:auto; height:35px; text-align:center;}
.ebs-basic-in .ebs-basic .slick-dots li:before {content:""; position:absolute; bottom:0; color:#fff;font-size:0;line-height:0;width:100%;height:4px;background:#fff;opacity:0.45}
.ebs-basic-in .ebs-basic .slick-dots li.slick-active:before {opacity:0.85}
.ebs-basic-in .ebs-basic .slick-dots a.dot {min-width:120px; display:inline-block; padding:0; color:#fff; font-size:16px; vertical-align:top;}
...
@media (max-width:1440px) {
	.ebs-basic-in .ebs-basic .slick-dots {bottom:30px;}
}
...
$(window).load(function(){
    ...
    $('.ebs-basic-wrap-<?php echo $es_code; ?> .ebs-basic').slick({
        ...
        customPaging: function(slider, i) { 
            ...
            return '<a class="dot">' + $(slider.$slides[i]).find('.ebs-basic-item').attr('data-dot-title') + '</a>';
        },
        autoplay: true,
        autoplaySpeed: 5000,
        responsive: [
