...
<style>
.ebs-shop-basic-wrap-<?php echo $es_code; ?> {position:relative; background:#fff;}
...
.ebs-shop-basic-in .ebs-shop-basic .ebs-shop-basic-item img {display:block;max-width:100%;height:auto; margin:0 auto;}
...
.ebs-shop-basic-in .ebs-shop-basic .ebs-shop-basic-item .ebs-shop-basic-cont h2 {display:none; color:#fff;font-weight:700}
.ebs-shop-basic-in .ebs-shop-basic .ebs-shop-basic-item .ebs-shop-basic-cont h5 {display:none; color:#fff;margin-top:20px;font-size:1.375rem}
.ebs-shop-basic-in .ebs-shop-basic .ebs-shop-basic-item .ebs-shop-basic-cont p {display:none;  margin-top:20px;font-size:1rem;color:#fff}
