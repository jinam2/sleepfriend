...
<style>
.ebs-basic-wrap-<?php echo $es_code; ?> {position:relative; background:#F2F4F5; padding:40px 30px;}
.ebs-basic-in {position:relative;overflow:hidden;display:none;}
.ebs-basic-in .ebs-basic .ebs-basic-item {position:relative;outline:none; text-align:center; padding:10px 20px 0;}
.ebs-basic-in .ebs-basic .ebs-basic-item img {display:block; width:100%;height:auto; border-radius:10px;}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont {position:relative; margin:20px 0 0;word-break:keep-all}
.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont h2 {display:block; color:#333; font-size:24px; font-weight:600; word-break:keep-all;}

.ebs-basic-in .ebs-basic .slick-next, .ebs-basic-in .ebs-basic .slick-prev {width:20px;height:40px;border:0;-webkit-transition: all .3s ease;-moz-transition: all .3s ease;-o-transition: all .3s ease;-ms-transition: all .3s ease;transition: all .3s ease}
.ebs-basic-in .ebs-basic .slick-next {right:0px;z-index:1}
.ebs-basic-in .ebs-basic .slick-prev {left:0px;z-index:1}
.ebs-basic-in .ebs-basic .slick-next:before, .ebs-basic-in .ebs-basic .slick-prev:before {content:"";display:block;position:absolute;top:50%;width:20px;height:20px;margin-top:-10px;-webkit-transform:rotate(45deg);-moz-transform:rotate(45deg);-o-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg)}
.ebs-basic-in .ebs-basic .slick-next:before {right:4px;border-right:1px solid #333;border-top:1px solid #333}
.ebs-basic-in .ebs-basic .slick-prev:before {left:4px;border-left:1px solid #333;border-bottom:1px solid #333}

@media (max-width:1440px) {
}

@media (max-width:1199px) {
	.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont h2 {font-size:20px;}
}

@media (max-width:768px) {
	.ebs-basic-wrap-<?php echo $es_code; ?> {padding:30px 20px;}
	.ebs-basic-in .ebs-basic .ebs-basic-item .ebs-basic-cont h2 {font-size:18px;}
}
...
<div class="ebs-basic-wrap-<?php echo $es_code; ?>">
    ...
    <div class="ebs-basic-in">
        <div class="ebs-basic">
            ...
            <div class="ebs-basic-item" data-dot-title="<?php echo $item['ei_title']?>">
                <?php if ($item['href_1']) { ?>
