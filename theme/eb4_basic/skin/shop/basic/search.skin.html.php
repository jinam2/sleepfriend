...
.shop-search .shop-search-form .search-box-header h4 {font-size:20px;padding-bottom:14px;margin-bottom:80px;border-bottom:1px solid #e1e1e1}
...
@media (max-width:991px) {
	...
	.shop-search .shop-search-form .search-box-header h4 {font-size:18px;margin-bottom:50px;}
}
@media (max-width:767px) {
	.shop-search .shop-search-form .search-box-header h4 {font-size:16px;margin-bottom:30px;}
}
...
<div class="shop-search">
    ...
    <div class="shop-search-form">
        ...
        <div class="search-box">
            <div class="search-box-header">
                <h4>“<?php echo $q; ?>”에 대한 검색 결과 <?php echo $total_count; ?>건</h4>
            </div>
            <div class="search-box-body" style="display:none;">
                <div class="row">
            ...
            <div class="search-box-footer" style="display:none;">
    ...
    <?php /* 검색된 분류 시작 */ ?>
    <div class="search-cate" style="display:none;">
        <ul>
            <?php if ($sca_count > 0) { ?>
