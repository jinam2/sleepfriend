...
.relation-10 .product-img {position:relative;overflow:hidden;background:#fff;  border-radius:10px;}
...
.relation-10 .product-description .product-description-in {position:relative;overflow:hidden;padding:0 0 10px; text-align:center;}
.relation-10 .product-description .product-name {position:relative;overflow:hidden; margin:10px 0 5px; line-height:1;}
.relation-10 .product-description .product-name a {font-size:20px; font-weight:600;color:#343434;  height:46px; text-decoration:none !important;}
.relation-10 .product-description .title-price {font-size:16px;font-weight:500;color:#3A3A3A}
...
.relation-10 .slick-next, .relation-10 .slick-prev {width:30px;height:60px;margin-top:-50px;text-align:center;background:rgba(0, 0, 0, 0.7)}
.relation-10 .slick-next {right:10px;z-index:1}
.relation-10 .slick-prev {left:10px;z-index:1}
...
@media (max-width:767px) {
	.relation-10 .product-description .product-name a {font-size:16px;}
	.relation-10 .product-description .title-price {font-size:14px;}
}
</style>
