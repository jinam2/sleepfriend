...
<style>
.shop-list-navcate-wrap {position:relative; padding:0;}
.shop-list-sort-wrap {position:relative; display:none;}
.banner {width:100%; height:300px; margin:0 0 50px; background:url(/images/sub_visual.png) no-repeat center center/cover; border-radius:10px;}
