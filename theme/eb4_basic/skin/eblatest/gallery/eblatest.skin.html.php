...
.gallery-item {position:relative;width:32.2%; float:left;}
.gallery-item + .gallery-item {margin-left:1.7%;}
.gallery-latest .gallery-img {position:relative;overflow:hidden;margin-bottom:15px}
.gallery-latest .img-box {position:relative;overflow:hidden;width:100%; height:210px;border-radius:10px;}
.gallery-latest .img-box img {position:absolute;top:50%; left:0;right:0;bottom:0; height:100%; -webkit-transform:translateY(-50%); -ms-transformY:translate(-50%); transform:translateY(-50%); border-radius:10px;}
...
.gallery-latest .gallery-txt {position:relative;}
.gallery-latest .txt-subj {position:relative;margin-bottom:10px}
.gallery-latest .txt-subj h5 {color:#000; font-size:20px;margin:0}
...
.gallery-latest .txt-subj h5 span {display:block; margin:5px 0 0; font-size:15px; color:#666; font-weight:400;}
...
@media (max-width:1220px) {
	.gallery-latest .txt-subj h5 span {font-size:14px;}
}
</style>
