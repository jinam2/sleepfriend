...
.member-skin .btn_confirm button {display:block; width:180px; margin:0 auto; height:50px; line-height:50px; padding:0; color:#141751; border:1px solid #141751;  font-size:15px; text-align:center; outline:none; background:#fff; border-radius:5px; font-weight:600; cursor:pointer;}
