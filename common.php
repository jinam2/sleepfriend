...
$g5['page_name'] = strtolower(basename($_SERVER['PHP_SELF']));
...
// 공통
//------------------------------------------------------------------------------
$custom_dbconfig_file = __DIR__."/custom_db_config.php";
$dbconfig_file = G5_DATA_PATH.'/'.G5_DBCONFIG_FILE;

if (file_exists($custom_dbconfig_file)) {
    include_once($custom_dbconfig_file);
...
} else if (file_exists($dbconfig_file)) {
