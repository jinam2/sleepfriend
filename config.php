...
//메일플러그(mailplug)용 설정 추가
define('G5_SMTP',           'smtp.mailplug.co.kr');
define('G5_SMTP_PORT',      '465');
define('G5_SMTP_SECURE',    'ssl');
define('G5_SMTP_USER',      'sleepfriend@sleepfriend.co.kr');
define('G5_SMTP_PW',        'rlackdgus1!');
...
//  230530, edited by jinam23 - 성별 사용여부 체크 
define("G5_MB_SEX_USE_FLAG", 0) ;