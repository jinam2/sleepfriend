...
<style>
#display_pay_button input {font-size:18px !important; height:48px; line-height:46px; font-weight:500 !important;}
#display_pay_button .btn_cancel {width:100%; display:block; height:48px; line-height:46px; border:1px solid #999;font-size:18px !important; text-align:center; outline:none; border-radius:5px; font-weight:600; cursor:pointer; background:#999; color:#fff; margin:4px 0 0;}
</style>