...
?>
    ...
    <form name="frmorderlist" class="local_sch01 local_sch">
        ...
        <select name="sel_field" id="sel_field">
            <option value="od_id" <?php echo get_selected($sel_field, 'od_id'); ?>>회원이름</option>
            <option value="mb_id" <?php echo get_selected($sel_field, 'mb_id'); ?>>ID</option>
            <option value="od_name" <?php echo get_selected($sel_field, 'od_name'); ?>>레코드유형</option>
            <option value="od_tel" <?php echo get_selected($sel_field, 'od_tel'); ?>>계약상태</option>
            <option value="od_hp" <?php echo get_selected($sel_field, 'od_hp'); ?>>상품종류</option>
            <option value="od_b_name" <?php echo get_selected($sel_field, 'od_b_name'); ?>>타입</option>
            <option value="od_b_tel" <?php echo get_selected($sel_field, 'od_b_tel'); ?>>보험구분</option>
            <option value="od_b_hp" <?php echo get_selected($sel_field, 'od_b_hp'); ?>>계약기간</option>
            <option value="od_deposit_name" <?php echo get_selected($sel_field, 'od_deposit_name'); ?>>납부금액</option>
