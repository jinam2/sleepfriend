...
if ($w == "u")
{
    ...
    if(trim($iq_answer)) {
        ...
        $push_message = "작성하신 상품문의에 답변이 등록되었습니다.";
        $target_url = G5_URL."/mypage/inquiry_view.php?iq_id=".$row['iq_id'];
        $push->sendGoodsQaReplyNotification($row['mb_id'], $push_message, $target_url);
