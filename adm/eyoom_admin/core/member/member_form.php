...
if ($w == '') {
    ...
    $airview = sql_fetch("select * from patients where salesforce_id = '{$mb['salesforce_id']}' ");
} else {
...
// 성별
$mb_sex_none         =  !$mb['mb_sex']  ? 'checked="checked"' : '';
$mb_sex_man         =  $mb['mb_sex'] == 'M'  ? 'checked="checked"' : '';
$mb_sex_woman       =  $mb['mb_sex'] == 'F'   ? 'checked="checked"' : '';
