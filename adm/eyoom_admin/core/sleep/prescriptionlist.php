...
$sel_field = (isset($_GET['sel_field']) && in_array($_GET['sel_field'], array('mb_name', 'mb_id','mb_hp', 'ID', 'CONTRACT_ID')) ) ? $_GET['sel_field'] : '';
...
$sql_common = " from SF_PRESCRIPTION T1 $sql_search ";
...
$qstr1 = "type_of_insurance=".urlencode($type_of_insurance)."&amp;fr_date=$fr_date&amp;to_date=$to_date&amp;sel_field=$sel_field&amp;search=$search&amp;save_search=$search";
