...
if(is_checked('chk_ca_it_sale'))                $ca_fields .= " , it_sale = '$it_sale' ";
if(is_checked('chk_ca_it_is_rental'))           $ca_fields .= " , it_is_rental = '$it_is_rental' ";
...
if(is_checked('chk_ca_it_rental_price'))        $ca_fields .= " , it_rental_price = '$it_rental_price' ";
...
if(is_checked('chk_all_it_sale'))                $all_fields .= " , it_sale = '$it_sale' ";
if(is_checked('chk_all_it_is_rental'))           $all_fields .= " , it_is_rental = '$it_is_rental' ";
...
if(is_checked('chk_all_it_rental_price'))        $all_fields .= " , it_rental_price = '$it_rental_price' ";
