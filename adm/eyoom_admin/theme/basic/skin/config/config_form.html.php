                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <div class="note"><strong>Note:</strong> 사용할 캡챠를 선택합니다.<br>1) Kcaptcha 는 기본캡챠입니다. ( 문자입력 )<br>2) reCAPTCHA V2 는 구글에서 서비스하는 원클릭 형식의 간편한 캡챠입니다. ( 모바일 친화적 UI )<br>3) Invisible reCAPTCHA 는 구글에서 서비스하는 안보이는 형식의 캡챠입니다. ( 간혹 퀴즈를 풀어야 합니다. )</div>
                            </td>
                        </tr>
            ...
            <div class="table-list-eb">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <?php } ?>
                            ...
                            <td>
                                <div class="inline-group">
                                    ...
                                    <!-- ADD -->
                                    <label for="cf_auth_hp" class="checkbox"><input type="checkbox" name="cf_auth_hp" value="1" id="cf_auth_hp" <?php echo $config['cf_auth_hp']?'checked':''; ?>><i></i> 휴대폰 인증</label>
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label for="cf_auth_hp_message" class="label">휴대폰 인증메시지</label>
                            </th>
                            <td colspan="3">
                                <label class="input form-width-500px">
                                    <input type="text" name="cf_auth_hp_message"value="<?php echo $config['cf_auth_hp_message'] ?>" id="cf_auth_hp_message">
                                </label>
                                <div class="note margin-bottom-10"><strong>Note:</strong> 발송되는 문자 양식입니다.</div>
                            </td>
                        </tr>
