                                ...
                                <div class="margin-bottom-5">
                                    <label class="select form-width-150px">
                                        <select name="sfl" id="sfl">
                                            ...
                                            <option value="a.salesforce_id"<?php echo get_selected($sfl, "a.salesforce_id"); ?>>세일즈포스ID</option>
                                        </select><i></i>
                                    </label>
                                </div>
                                <span>
...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            ResMed: "<label class='checkbox'><input type='checkbox' name='resmed[<?php echo $i; ?>]' <?php if ($list[$i]['resmed_patient']) { ?>checked<?php } ?> value='1' disabled><i></i></label>",
            <?php if (!$wmode) { ?>
...
$(function() {
    $("#member-list").jsGrid({
        ...
        fields         : [
            ...
            { name: "세일즈포스ID", type: "text", width: 180 },
            { name: "ResMed", type: "text", width: 80 },
            <?php if (!$wmode) { ?>
