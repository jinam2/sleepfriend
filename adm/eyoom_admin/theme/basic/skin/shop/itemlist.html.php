...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            구매: "<label class='checkbox'><input type='checkbox' name='it_sale[<?php echo $i; ?>]' id='it_sale_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_sale'] ? 'checked':''; ?>><i></i></label>",
            렌탈: "<label class='checkbox'><input type='checkbox' name='it_is_rental[<?php echo $i; ?>]' id='it_is_rental_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_is_rental'] ? 'checked':''; ?>><i></i></label>",
            ...
            렌탈비용: "<label class='input'><input type='text' name='it_rental_price[<?php echo $i; ?>]' id='it_rental_price_<?php echo $i; ?>' value='<?php echo $list[$i]['it_rental_price']; ?>'>",
...
$(document).ready(function(){
    $("#admin-shop-itemlist").jsGrid({
        ...
        fields         : [
            ...
            { name: "구매", type: "text", align:"center", width: 40 },
            { name: "렌탈", type: "text", align:"center", width: 40 },
