            ...
            <div class="table-list-eb">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label for="it_sale" class="label">구매가능</label>
                            </th>
                            <td>
                                <label class="checkbox" style="width:80px;">
                                    <input type="checkbox" name="it_sale" value="1" id="it_sale" <?php echo ($it['it_sale']) ? "checked" : ""; ?>><i></i> 예
                                </label>
                                <div class="note"><strong>Note:</strong> 구매가능여부가 체크된 경우에, 사용자가 구매 가능합니다.</div>
                            </td>
                            <td class="table-chk-td">
                                <div class="inline-group">
                                    <label for="chk_ca_it_sale" class="checkbox"><input type="checkbox" name="chk_ca_it_sale" value="1" id="chk_ca_it_sale"><i></i>분류적용</label>
                                    <label for="chk_all_it_sale" class="checkbox"><input type="checkbox" name="chk_all_it_sale" value="1" id="chk_all_it_sale"><i></i>전체적용</label>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label for="it_is_rental" class="label">렌탈가능</label>
                            </th>
                            <td>
                                <label class="checkbox" style="width:80px;">
                                    <input type="checkbox" name="it_is_rental" value="1" id="it_is_rental" <?php echo ($it['it_is_rental']) ? "checked" : ""; ?>><i></i> 예
                                </label>
                                <div class="note"><strong>Note:</strong> 렌탈 가능 여부가 체크된 경우, 상품 주문창에 렌탈을 선택할수 있습니다.</div>
                            </td>
                            <td class="table-chk-td">
                                <div class="inline-group">
                                    <label for="chk_ca_it_is_rental" class="checkbox"><input type="checkbox" name="chk_ca_it_is_rental" value="1" id="chk_ca_it_is_rental"><i></i>분류적용</label>
                                    <label for="chk_all_it_is_rental" class="checkbox"><input type="checkbox" name="chk_all_it_is_rental" value="1" id="chk_all_it_is_rental"><i></i>전체적용</label>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label for="it_rental_price" class="label">렌탈가격</label>
                            </th>
                            <td>
                                <label class="input form-width-250px">
                                    <input type="text" name="it_rental_price" value="<?php echo get_text($it['it_rental_price']); ?>" id="it_rental_price">
                                </label>
                                <div class="note"><strong>Note:</strong> 입력하지 않으면 표시되지 않습니다. 렌탈가격은 텍스트로도 입력가능합니다.</div>
                            </td>
                            <td class="table-chk-td">
                                <div class="inline-group">
