        ...
        <div class="table-list-eb">
            ...
            <table class="table">
                <tbody>
                    ...
                    <?php } else if($iq['od_id']) {?>
                        <tr>
                            <th class="table-form-th">
                                <label class="label">주문 정보</label>
                            </th>
                            <td>
                                <strong><a href="<?php echo G5_ADMIN_URL;?>/?dir=shop&pid=orderform&od_id=<?php echo $iq['od_id']; ?>" target="_blank"><?php echo $iq['od_id']; ?></a></strong>
                            </td>
                        </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="textarea">
                                <?php echo editor_html('iq_question', get_text(html_purifier($iq['iq_question']), 0), 0); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="textarea">
                                <?php echo editor_html('iq_answer', get_text(html_purifier($iq['iq_answer']), 0), 0); ?>
                            </div>
                        </td>
                    </tr>
                </tbody>
