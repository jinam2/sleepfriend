                    ...
                    <tr>
                        ...
                        <td>
                            <div for="is_content" class="textarea">
                                <?php echo editor_html('is_content', get_text(html_purifier($is['is_content']), 0), 0); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div for="is_reply_content" class="textarea">
                                <?php echo editor_html('is_reply_content', get_text(html_purifier($is['is_reply_content']), 0), 0); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
