        ...
        window.db    = db,
            db.clients   = [
                <?php for ($i=0; $i<count((array)$list); $i++) { ?>
                {
                    ...
                    airview_id: "<?php echo $list[$i]['id']; ?>",
                    airview_name: "<?php echo $list[$i]['username']?>",
                    세일즈포스ID: "<?php echo $list[$i]['salesforce_id']?>",
                    이름: "<?php echo $list[$i]['mb_name']?>",
                    셋업일: "<?php echo $list[$i]['setup_date']?>",
                    사용량: "<?php echo $list[$i]['pdf_values']['사용량']?>",
                    평균사용: "<?php echo $list[$i]['total_avg_used_hourmin']?>",
                    누출_중간값: "<?php echo $list[$i]['leak_median_value']?>",
                    무호흡지수_중앙: "<?php echo $list[$i]['ahi_median_value']?>",
                    pdf: "<?php if($list[$i]['pdf_link']) {?><a href='<?=$list[$i]['pdf_link']?>' target='_blank'><strong><?=$list[$i]['pdf_filename']?></strong><i class='fas fa-download margin-right-5 hidden-xs'></i></a><?php }?>",
                    text: "<a href='<?=$list[$i]['pdf_link']?>' target='_blank' class='btn btn-secondary btn-sm'>pdf</a>",
                    갱신: "",
                },
                <?php } ?>
            ]
    ...
    $(document).ready(function(){
        $("#order-list").jsGrid({
            ...
            fields         : [
                ...
                { name: "airview_id", type: "text", align: "center", width: 100 },
                { name: "airview_name", type: "text", align: "center", width: 200 },
                { name: "세일즈포스ID", type: "text", align: "center",  width: 150 },
                { name: "이름", type: "text", align: "center",  width: 100 },
                { name: "셋업일", type: "text", align: "center",  width: 100 },
                { name: "사용량", type: "text",  align: "center", width: 180 },
                { name: "평균사용", type: "text",  align: "center", width: 80 },
                { name: "누출_중간값", type: "number", align: "center",  width: 100 },
                { name: "무호흡지수_중앙", type: "number", align: "center", width: 100 },
                { name: "pdf", type: "text", align: "center",  width: 300 },
                { name: "text", type: "text", align: "center",  width: 100 },
                { name: "갱신", type: "button", width: 140 },
            ]
        })
...
<script>
    $(function(){
        ...
        $("#btn_reload_contract").click(function() {
