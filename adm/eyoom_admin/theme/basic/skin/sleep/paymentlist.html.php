...
<div class="admin-shop-orderlist">
    <form id="frmcontractlist" name="frmcontractlist" class="eyoom-form" method="get">
        ...
        <div class="adm-headline">
            <h3>이체내역</h3>
            <a href="javascript:;" id="btn_reload_payment" class="btn-e btn-e-red btn-e-lg"><i class="fas fa-refresh"></i> salesforce 이체 내역 갱신</a>
        </div>
        ...
        window.db    = db,
            db.clients   = [
                <?php for ($i=0; $i<count((array)$list); $i++) { ?>
                {
                    ...
                    이체ID: "<?php echo $list[$i]['ID']?>",
                    환자명: "<?php echo $list[$i]['mb_name']?>",
                    환자ID: "<?php echo $list[$i]['PATIENT_ID']; ?>",
                    지불유형: "<?php echo $list[$i]['METHOD']?>",
                    예금주_카드발급자명: "<?php echo $list[$i]['ACCOUNT_NAME']?>",
                    은행_카드사명: "<?php echo $list[$i]['BANKCARD_NAME']?>",
                    계좌_카드번호: "<?php echo $list[$i]['BANKCARD_NUMBER']?>",
    ...
    $(document).ready(function(){
        $("#order-list").jsGrid({
            ...
            fields         : [
                ...
                { name: "이체ID", type: "text", align: "center", width: 200, },
                { name: "지불유형", type: "text", align: "center", width: 100 },
                { name: "예금주_카드발급자명", type: "text", align: "center",  width: 100 },
                { name: "은행_카드사명", type: "number",  align: "center", width: 140 },
                { name: "계좌_카드번호", type: "number",  align: "center", width: 140 },
...
<script>
    $(function(){
        ...
        $("#btn_reload_payment").click(function(e) {
            if(!confirm('이체 내역 정보를 다시 불러오시겠습니까?')) {
                return;
            }
            e.preventDefault();
