 ...
 * @file    ~/theme/basic/skin/sleep/rentallist.html.php
 */
            ...
            <div class="table-list-eb">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label class="label">렌탈방법</label>
                            </th>
                            <td>
                                <div class="inline-group">
                                    <label for="od_rental_type_all" class="radio"><input type="radio" name="od_rental_type" id="od_rental_type_all" value="" <?php echo trim($od_rental_type) == "" ? "checked" : "";?>><i></i> 전체</label>
                                    <label for="od_rental_type_noinsurance" class="radio"><input type="radio" name="od_rental_type" id="od_rental_type_noinsurance" value="noinsurance" <?php echo $od_rental_type=="noinsurance" ? "checked" : ""; ?>><i></i> 비보험렌탈</label>
                                    <label for="od_rental_type_insurance" class="radio"><input type="radio" name="od_rental_type" id="od_rental_type_insurance" value="insurance" <?php echo $od_rental_type=="insurance" ? "checked" : "";?>><i></i> 보험렌탈</label>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                ...
                <h4 class="modal-title">렌탈 상태 수정</h4>
            </div>
        ...
        window.db    = db,
            db.clients   = [
                <?php for ($i=0; $i<count((array)$list); $i++) { ?>
                {
                    ...
                    관리: "<?php if ($is_admin!='group') { ?><a href='<?php echo G5_ADMIN_URL; ?>/?dir=sleep&amp;pid=rental_form&amp;od_id=<?php echo $list[$i]['od_id']; ?>&amp;w=u<?php if ($qstr) { ?>&amp;<?php echo $qstr; ?><?php } ?>'><u>수정</u></a><?php } ?>",
                    이름: "<?php echo $list[$i]['mb_name']?>",
                    주문ID: "<span class='ellipsis'><a <?php if (!(G5_IS_MOBILE || $wmode)) { ?>href='<?php echo G5_ADMIN_URL; ?>/?dir=sleep&pid=rental_form&od_id=<?php echo $list[$i]['od_id']; ?>&w=u&amp;wmode=1' onclick='eb_modal(this.href); return false;'<?php } else { ?>href='javascript:void(0);'<?php } ?> ><i class='fas fa-external-link-alt color-light-grey margin-right-5 hidden-xs'></i><strong><?php echo $list[$i]['od_id']; ?></strong></a></span>",
                    렌탈방법: "<?php echo $list[$i]['rental_type_name']?>",
                    렌탈제품: "<?php echo $list[$i]['it_name']?>",
                    상태: "<?php echo $list[$i]['od_status']?>",
                    신청일: "<?php echo $list[$i]['od_datetime']?>",
                    기타: "",
                },
                <?php } ?>
            ]
    ...
    $(document).ready(function(){
        $("#store-list").jsGrid({
            ...
            fields         : [
                ...
                { name: "렌탈제품", type: "text", align: "left", width: 250 },
                { name: "렌탈방법", type: "text", align: "center", width: 100 },
                { name: "상태", type: "text", align: "center", width: 100 },
                { name: "신청일", type: "text", align: "center", width: 150 },
