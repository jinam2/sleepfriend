 ...
 * @file    ~/theme/basic/skin/board/qalist.html.php
 */
    ...
    !function () {
        ...
        window.db    = db,
            db.clients   = [
                ...
                {
                    관리: "<a href='<?php echo G5_ADMIN_URL; ?>/?dir=sleep&amp;pid=qalist_update&amp;w=d&amp;qa_id=<?php echo $list[$i]['qa_id']; ?>&amp;smode=1' class='margin-left-10' onclick='return delete_confirm(this);'><u>삭제</u></a>",
                    ID: "<?php echo $list[$i]['qa_id']; ?>",
                    이름: "<?php echo $list[$i]['qa_name']; ?>",
                    유형: "<?php echo htmlspecialchars2($list[$i]['qa_category']); ?>",
                    분류: "<?php echo htmlspecialchars2($list[$i]['qa_group']); ?>",
                    제목: "<a href='<?php echo G5_ADMIN_URL; ?>/?dir=sleep&amp;pid=qaform&amp;w=a&amp;qa_id=<?php echo $list[$i]['qa_id']; ?>'><?php echo htmlspecialchars2($list[$i]['qa_subject']); ?></a>",
                    상담일정: "<?php echo $list[$i]['qa_2']; ?>",
    ...
    $(function() {
        $("#content-list").jsGrid({
            ...
            fields         : [
                ...
                { name: "상담일정", align: "center", type: "text", width: 200},
