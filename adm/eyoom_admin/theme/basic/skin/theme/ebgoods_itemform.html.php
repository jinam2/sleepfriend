        ...
        <div class="table-list-eb">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th class="table-form-th">
                            <label class="label">추출 상품 속성</label>
                        </th>
                        <td>
                            <label for="gi_type" class="select form-width-250px">
                                <select name="gi_type" id="gi_type">
                                    <option value="">::전체::</option>
                                    <option value="1" <?php echo $gi['gi_type'] == '1' ? 'selected':''; ?>>히트상품출력</option>
                                    <option value="2" <?php echo $gi['gi_type'] == '2' ? 'selected':''; ?>>추천상품출력</option>
                                    <option value="3" <?php echo $gi['gi_type'] == '3' ? 'selected':''; ?>>최신상품출력</option>
                                    <option value="4" <?php echo $gi['gi_type'] == '4' ? 'selected':''; ?>>인기상품출력</option>
                                    <option value="5" <?php echo $gi['gi_type'] == '5' ? 'selected':''; ?>>할인상품출력</option>
                                </select><i></i>
                            </label>
                            <div class="note"><strong>Note:</strong> 출력대상이 되는 상품의 출력방식을을 설정합니다.</div>
                        </td>
