...
class OneSignalSync
{
    ...
    public function sendUserNotification($userid, $message, $data = []) {
    ...
    public function sendGoodsReplyNotification($userid, $goods_name, $goods_id) {

        $message = sprintf("작성하신 상품문의에 답변이 등록되었습니다.");
        $data = [
            'type' => 'goods_reply',
            'goods_id' => $goods_id
        ];
        $this->sendUserNotification($userid, $message, $data);
    }
