    ...
    if ($eg_master['eg_state'] == '1' || ($is_admin && $eg_master['eg_skin'])) {
        ...
        */
        ...
        for ($i=0; $i<$eg_count; $i++) {
             ...
             * 상품 속성 타입
             */
            if(!isset($eg_item[$i]['gi_type'])) {

            }
            switch ($eg_item[$i]['gi_type']) {
                default :
                case '1': $sql_where .= ' and it_type1 = 1 '; break; //히트상품출력
                case '2': $sql_where .= ' and  it_type2 = 1 '; break; //추천상품출력
                case '3': $sql_where .= ' and  it_type3 = 1'; break; //최신상품출력
                case '4': $sql_where .= ' and  it_type4 = 1'; break; //인기상품출력
                case '5': $sql_where .= ' and  it_type5 = 1 '; break; //할인상품출력
