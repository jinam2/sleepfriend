...
class theme extends qfile
{
    ...
    private function eyoom_subpage_info($theme) {
        global $g5, $it_id, $is_admin, $ca_id, $sca, $board, $member, $ev;
        ...
        if ($data['me_id']) {
            ...
            $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li>".$path;
            ...
            if($ev) { //기획전 페이지는 기획전 이름을 표시
                $page_info['title'] = $ev['ev_subject'];
            }
        }
        if (!$page_info['title']) {
            if ($is_admin) {
    ...
    private function g5_subpage_info($menu_array) {
        ...
        if ($bo_table || $co_id) {
            ...
            if ($submenu) {
                ...
                $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li><a href='".$submenu['cate1']['link']."' > " . $submenu['cate1']['name'] . "</a></li><li class='active'>" . $submenu['cate2']['me_name']."</li>";
            }

            if (!$page_info) {
                if ($bo_table) {
                    $page_info['title'] = $board['bo_subject'];
                    $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li class='active'>".$board['bo_subject']."</li>";
                } else if ($co_id) {
                    $page_info['title'] = $co['co_subject'];
                    $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li class='active'>".$co['co_subject']."</li>";
                }
            }
        } else if ($gr_id) {
            // Group 페이지 정보
            ...
            if ($group['gr_subject']) {
                ...
                $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li class='active'>".$group['gr_subject']."</li>";
            }
    ...
    private function get_default_page() {
        ...
        switch($key) {
            ...
            case 'search'           : $title = '검색결과';; $cate_name = '쇼핑몰'; break;
            ...
            case 'orderform'        : $title = '주문서 작성'; $cate_name = '쇼핑몰'; break;
            case 'orderinquiryview' : $title = '주문완료'; $cate_name = '쇼핑몰'; break;
        ...
        if (defined('_TAG_')) {
            ...
            if ($_GET['tag']) {
                ...
                $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li>태그</li><li>".str_replace('*','</li><li>',$tag)."</li>";
                $page_info['subtitle'] = '태그';
            } else {
                $page_info['title'] = '태그 크라우드';
                $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li>태그</li><li>".$page_info['title']."</li>";
                $page_info['subtitle'] = '태그';
            }
        } else if (!$cate_name) {
            $page_info['title'] = $title;
            $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li class='active'>".$title."</li>";
        } else {
            $page_info['title'] = $title;
            $page_info['path'] = "<li><a href='".G5_URL."'>홈</a></li><li>".$cate_name."</li><li class='active'>".$title."</li>";
    ...
    public function shop_subpage_info() {
        ...
        $pageinfo['path'] = "<li><a href='".G5_URL."'>홈</a></li><li><a href='".G5_URL."/shop'>쇼핑몰</a></li>".$path['path'];
