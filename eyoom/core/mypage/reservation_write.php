...
$write = array('qa_email_recv'=>'', 'qa_subject'=>'', 'qa_category'=>'', 'qa_group');
...
if($w == "u") {
    $write['reservation_date'] = $write['qa_2'] ? substr($write['qa_2'], 0, 10) : "";
    $write['reservation_time'] = $write['qa_2'] ? date("H:i A", strtotime($write['qa_2'])) : "";
    $write['reservation_time']  = str_replace(['AM', 'PM'], ['오전', '오후'], $write['reservation_time']);
}
 ...
 * 사용자 프로그램
 */
@include_once(EYOOM_USER_PATH.'/mypage/reservation_write.php');

/**
 * HTML 출력
 */
include_once($eyoom_skin_path['mypage'].'/reservation_write.skin.html.php');