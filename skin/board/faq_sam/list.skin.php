...
<!--
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?>
			<li>
				<a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기" style="border:1px solid #000; color:#5f5f5f !important;"><i class="fa fa-pencil" aria-hidden="true" style="color:#5f5f5f !important; border:1px solid #000; font-size:20px; width:30px height:30px;"></i><span class="sound_only">글쓰기</span></a>
				</li>
				<?php } ?>
		...
		<ul class="faq_list_board">
			...
			<li>
				...
				<p class="q">
					...
					<a href="<?php echo $write_href.$amp?>w=u&wr_id=<?php echo $list[$i]['wr_id']?>&page=<?php echo $page?>" class="btn-e-sm btn-e-dark">수정</a>
					<?php } ?>	
				</p>
				<div class="answer">
