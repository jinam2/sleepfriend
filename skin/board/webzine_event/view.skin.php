...
<style>
.board-view {font-size:16px; border-top:2px solid #141751;}
...
.board-view .board-view-subj {font-size:20px; padding:15px 0; border-bottom:1px solid #eaeaea; text-align:center; color:#333;}
.board-view .board-view-subj .category {color:#FD4F00;}
.board-view .board-view-subj strong {font-weight:500;}
...
.board-view .board-view-file ul {margin-bottom:0; font-size:14px; color:#5f5f5f;}
.board-view .board-view-file li {padding:10px;border-bottom:1px solid #eaeaea}
.board-view .board-view-file a:hover {text-decoration:underline}
.board-view .board-view-file span {margin-left:7px}
.board-view .board-view-file span i {margin-right:4px;color:#b5b5b5}
.board-view .board-view-file strong {font-weight:400;}
...
.board-view .board-view-file-conts #bo_v_img img {display:block;max-width:100%;height:auto; margin:30px auto;}
.board-view .board-view-con {position:relative;overflow:hidden; padding:30px 10px;width:100%;word-break:break-all; line-height:160%; color:#5f5f5f; border-bottom:1px solid #141751;}
...
@media (max-width:767px) {
	...
	.board-view .board-view-subj {font-size:18px;}
}
...
<article class="board-view">
    ...
    <h3 class="board-view-subj">
        ...
        <span class="category m-r-5">[<?php echo $view['ca_name'] ?>]</span>
        <?php } ?>
        ...
        <ul class="list-unstyled">
            <li>
                <div class="float-start">
                   <i class="far fa-clock"></i> 기간 : <?php echo $write['wr_1']." ~ ".$write['wr_2']; ?>
                </div>
        ...
        <?php for ($i=0; $i<count((array)$view_file); $i++) { ?>
            <li>
                ...
                <div class="float-end text-end hidden-xs">
                    ...
                    <span><?php echo $view_file[$i]['datetime']; ?></span>
                </div>
                <div class="clearfix"></div>
            </li>
        <?php } ?>
    ...
    <div class="board-view-atc" id="view_good_nogood">
        ...
        <?php } ?>
        <div id="board_view_con" class="board-view-con view-content"><?php echo get_view_thumbnail($view['content']); ?></div>
    ...
    <div class="view-top-btn">
        ...
        <ul class="top-btn-left list-unstyled float-start">
            <?php if ($prev_href) { ?>
            <li><a href="<?php echo $prev_href; ?>" class="btn-e-lg btn-e-dark" type="button">이전</a></li>
            <?php } ?>
            <?php if ($next_href) { ?>
            <li><a href="<?php echo $next_href; ?>" class="btn-e-lg btn-e-dark" type="button">다음</a></li>
            <?php } ?>
        </ul>
        <?php } ?>
        <?php } ?>
        <ul class="top-btn-right list-unstyled float-end">
            <?php if ($search_href) { ?>
            <!--li><a href="<?php echo $search_href; ?>" class="btn-e-lg btn-e-dark" type="button">검색</a></li-->
            <?php } ?>
            <?php if ($update_href) { ?>
            <li><a href="<?php echo $update_href; ?>" class="btn-e-lg btn-e-dark" type="button">수정</a></li>
            <?php } ?>
            <?php if ($delete_href) { ?>
            <li><a href="<?php echo $delete_href; ?>" class="btn-e-lg btn-e-dark" type="button" onclick="del(this.href); return false;">삭제</a></li>
            <?php } ?>
            <?php if (!$wmode) { ?>
            <li><a href="<?php echo $list_href; ?>" class="btn-e-lg btn-e-dark" type="button">목록</a></li>
                <?php if ($reply_href) { ?>
            <li><a href="<?php echo $reply_href; ?>" class="btn-e-lg btn-e-dark" type="button">답변</a></li>
                <?php } ?>
                <?php if ($write_href) { ?>
            <li><a href="<?php echo $write_href; ?>" class="btn-e-lg btn-e-dark" type="button">글쓰기</a></li>
                <?php } ?>
            <?php } ?>
        </ul>
        <div class="clearfix"></div>
