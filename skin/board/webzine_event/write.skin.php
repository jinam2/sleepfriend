    ...
    <section>
        <div class="row">
            <div class="col col-12 md-m-b-10">
                <div class="position-relative">
                    <label for="wr_subject" class="label">
                        기간<strong class="sound_only"> 필수</strong>
                    </label>
                <div class="inline-group">
                    <label class="input2">
                        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="required required-mark" size="20">
                    </label>
					~
                    <label class="input2">
                        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="required required-mark" size="20">
                    </label>
					</div>
                </div>
            </div>
